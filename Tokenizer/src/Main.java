/* Assignment 1,Part 1: Tokenizing
 * By Shubham Rai
 * Net id: scr130130
 */

/*This class contains the main function, it  takes as input the directory path to the Cranfield folder 
  and calls the Tokenizer class to tokenize the text based on certain criteria's and displays the output in the console.
...
public class Main {
	...
	public static void main(String[] args) throws Exception {
		...
		System.out.println("5. The average number of word tokens per document = "+ (noOfTokens/tokenizer.getNoOfDocs()) );		
		System.out.println("6. The 30 most frequent words and their frequencies");
		
		// Tree set for sorting the tokens in descending order.
		TreeSet<Entry<String, Integer>> sortedMap = new TreeSet<Entry<String, Integer>>(new ValueComparator());
		sortedMap.addAll(data.entrySet());
		Iterator<Entry<String, Integer>> iterator = sortedMap.descendingIterator();
